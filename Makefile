...
# ASM_PATH=.
LIB_PATH=../../verilib
PCI_PATH=${LIB_PATH}/pci
MEM_PATH=${LIB_PATH}/ram
WBC_PATH=${LIB_PATH}/wbc
CPU_PATH=${LIB_PATH}/cpu
TTA_PATH=${WBC_PATH}/cpu/tta16
VID_PATH=video
XPATH=${LIB_PATH}/xilinx_sim
# TTA_PATH=tta

LIB_FILES=${LIB_PATH}/fifo/async/afifo16.v ${LIB_PATH}/fifo/async/afifo2k.v ${LIB_PATH}/counter/bin2gray.v ${WBC_PATH}/util/wb_mux4to1.v ${LIB_PATH}/mux/mux4to1.v ${LIB_PATH}/mfsr/mfsr7.v ${LIB_PATH}/mfsr/mfsr8.v ${LIB_PATH}/mfsr/mfsr9.v ${LIB_PATH}/mfsr/mfsr10.v ${LIB_PATH}/mfsr/mfsr11.v ${LIB_PATH}/wbc/wb_leds.v ${LIB_PATH}/counter/fib/fib20.v ${LIB_PATH}/clock/clkdiv.v

CACHE_FILES=${WBC_PATH}/cache/wb_simple_cache.v ${WBC_PATH}/cache/wb_cache_flush.v ${LIB_PATH}/cache/fetch_wb.v

RISC_FILES=${RISC_PATH}/risc16_tile.v ${RISC_PATH}/risc16.v ${RISC_PATH}/fetch.v ${RISC_PATH}/decode.v ${RISC_PATH}/execute.v ${RISC_PATH}/branch.v ${RISC_PATH}/memory.v ${RISC_PATH}/risc_alu.v ${CACHE_FILES} ${CPU_PATH}/fastbits.v  ${WBC_PATH}/util/wb_dma.v ${WBC_PATH}/util/pre_read.v ${WBC_PATH}/util/wb_sync.v

TTA_FILES=${TTA_PATH}/tta16_tile.v ${TTA_PATH}/tta16.v ${CACHE_FILES} ${CPU_PATH}/fastbits.v  ${WBC_PATH}/util/wb_dma.v ${WBC_PATH}/util/pre_read.v ${WBC_PATH}/util/wb_sync.v ${CPU_PATH}/tta/tta_stream8to32.v ${CPU_PATH}/tta/tta_stream8to8.v ${CPU_PATH}/tta/tta_stream4to4.v ${CPU_PATH}/tta/tta_stream4to8.v

MEM_FILES=${WBC_PATH}/wb_sdram_ctrl.v ${MEM_PATH}/ddr/ddr_datapath.v ${MEM_PATH}/sdr/rfc.v

WBC_FILES=${WBC_PATH}/wb_sprom.v ${WBC_PATH}/wb_pci_top.v ${PCI_PATH}/cfgspace.v ${WBC_PATH}/wb_new_pci_mem.v

VID_FILES=${WBC_PATH}/wb_crtc.v ${VID_PATH}/crtc.v ${VID_PATH}/prefetch.v  ${VID_PATH}/vga16.v  ${VID_PATH}/wb_redraw.v

COMMON_FILES=freega_top.v freega_io.v ${LIB_FILES} ${TTA_FILES} ${WBC_FILES} ${VID_FILES} ${MEM_FILES}
XFILES=${COMMON_FILES}
IFILES=${COMMON_FILES} freega_tb.v ${PCI_PATH}/pci_stresstest.v ${PCI_PATH}/pci_testblock.v ${PCI_PATH}/pci_gencmds.v  ${LIB_PATH}/fifo/sync/sfifo2k.v ${MEM_PATH}/sdr/mt48lc4m16a2.v ${XPATH}/IBUF.v ${XPATH}/OBUF.v ${XPATH}/BUFG.v ${XPATH}/DCM.v ${XPATH}/RAMB16_S36_S36.v ${XPATH}/OFDDRTRSE.v ${XPATH}/IFDDRRSE.v ${XPATH}/MUXCY.v ${XPATH}/RAMB16_S18_S18.v ${XPATH}/RAMB16_S18_S36.v ${XPATH}/RAM16X1S.v

# (optional) Name of top module. Defaults to name of first file with suffix removed
TOP_MODULE=freega_top
