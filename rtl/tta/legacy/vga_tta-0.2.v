...
module vga_tta (
	clock_i,
	reset_ni,
	gate_ni,	// Pause (gate) execution when asserted
...
wire	[3:0]	rf0_idx	= instr[18:15];
wire	[3:0]	rf1_idx	= instr[22:19];
...
// ALU0.
always @(posedge clock_i) begin
//always @(posedge clock_i or negedge gate_ni) begin
	if (!reset_ni || !gate_ni) begin
		alu0_src_sel	<= 0;
		alu0_dst_sel	<= 0;
	end
	else begin
...
always @(posedge clock_i) begin
	if (gate_ni)
		case (alu0_src)
		2'b00:	alu0_data	<= com;
		2'b01:	alu0_data	<= rf0_data;	// Load from the RF0
		2'b10:	alu0_data	<= bitwise;
		2'b11:	alu0_data	<= immed;
		endcase
end
...
always @(posedge clock_i) begin
	if (gate_ni)
		case (alu1_src)
		2'b00:	alu1_data	<= prod_lo;
		2'b01:	alu1_data	<= prod_hi;
		2'b10:	alu1_data	<= dmux;
		2'b11:	alu1_data	<= rf1_data;
		endcase
end
...
wire	[VDMSB:0]	flags_w	= {{(VDMSB-2){1'b0}}, {flag_p, flag_v, flag_z}};
always @(posedge clock_i) begin
	if (gate_ni)
		case (alu2_src)
		2'b00:	alu2_data	<= com;
		2'b01:	alu2_data	<= inc;
		2'b10:	alu2_data	<= flags_w;
		2'b11:	alu2_data	<= pc;	// Store PC when branching
		endcase
end
...
initial begin : Init
	...
	iram[2]	<= 36'b000000000__0010_0000_0000__01__00_00__00_00__000_00;
	
	// mov { com -> com ; plo -> com ; com -> com ; com -> r0 ; }
	iram[3]	<= 36'b000000000__0000_0000_0000__00__00_00__00_00__000_00;
	
	// mov { com -> sub ; plo -> mul ; flags -> com ; com -> r0 ; }
	iram[4]	<= 36'b000000000__0000_0000_0000__00__00_10__11_00__100_00;
	
	// mov { #04 -> and ; r2 -> mul ; com -> com ; com -> r0 ; }
	iram[5]	<= 36'b000000100__0000_0010_0000__00__00_00__11_11__010_11;
